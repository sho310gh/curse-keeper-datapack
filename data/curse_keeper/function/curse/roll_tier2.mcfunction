# Curse 2 = Frail Vessel, Curse 3 = Nether Sickness, Curse 7 = Soul Drain, Curse 19 = Picky Eater
# Curse 10 = Vampirism, Curse 13 = Grave Pact, Curse 14 = Landlocked
execute store result score @s ck.curse_id run random value 1..7
...
execute if score @s ck.curse_id matches 7 run scoreboard players set @s ck.curse_id 19