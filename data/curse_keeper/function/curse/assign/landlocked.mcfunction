...
# Restriction: Constant damage when submerged in water
...
tellraw @s [{"text":"Restriction: ","color":"gray"},{"text":"Water is your enemy. Submerging yourself deals constant damage.","color":"white"}]
