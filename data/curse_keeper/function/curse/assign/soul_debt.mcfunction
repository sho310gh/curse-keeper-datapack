...
# Cleanse: Kill the Ender Dragon 5 times AND kill 10 players
# ============================================================
...
tellraw @s [{"text":"Cleanse: ","color":"gray"},{"text":"Kill the Ender Dragon 5 times AND kill 10 players.","color":"green"}]